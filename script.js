...
const VIDEO_GROUP_DATA = {
    funny_trio: [
        { src: "video/video_2025-11-23_21-23-44.mp4", caption: "Нуб-момент 1: Что ты несешь?" },
        { src: "video/video_2025-11-23_21-23-50.mp4", caption: "Нуб-момент 2: Неловкое молчание." },
        { src: "video/video_2025-11-23_21-23-55.mp4", caption: "Нуб-момент 3: Случайная реакция." }
    ]
